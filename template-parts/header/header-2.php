<?php
/**
 * Header template part: header-2 (transparent over hero).
 *
 * Same markup as header-1 but with a modifier class so the CSS renders it
 * transparent until the user scrolls, at which point it becomes solid.
 *
 * @package Primex
 */
...
<header id="primex-header" class="primex-header primex-header--transparent" role="banner" data-primex-header data-primex-sticky="<?php echo primex_get_sticky_header() ? 'true' : 'false'; ?>">
